# Return subsets
# Problem Statement
# Given an integer array, find and return all the subsets of the array. The order of subsets in the
# output array is not important. However the order of elements in a particular subset should remain the same as in
# the input array.
#
# Note:
#
