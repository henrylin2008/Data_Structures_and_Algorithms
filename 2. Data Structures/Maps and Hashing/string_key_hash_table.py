...
# strings in the buckets. The (bucket) index is calculated by the first two letters of the string, according to the
# formula below:
#       Hash Value = (ASCII Value of First Letter * 100) + ASCII Value of Second Letter

# In the formula above, the generated hash value is the (bucket) index.
#
# Example: For a string "UDACITY", the ASCII value for letters 'U' and 'D' are 85 and 68 respectively. The hash value
# would be: (85 *100) + 68 = 8568.
#
# You can use the Python function ord() to get the ASCII value of a letter, and chr() to get the letter associated
# with an ASCII value.
#
# Assumptions
...
#   * Store lists at each bucket, and not just the string itself. For example, you can store "UDACITY" at index 8568
#    as ["UDACITY"].
#
# Instructions
...
#   * lookup() - a function that checks if a string is already available in the hash table. If yes, return the hash
#                value, else return -1.
