...
# print("Pass" if (check_output(permute([]), [[]])) else "Fail")  # Pass
# print("Pass" if (check_output(permute([0]), [[0]])) else "Fail")  # Pass
# print("Pass" if (check_output(permute([0, 1]), [[0, 1], [1, 0]])) else "Fail")    # Pass
# print("Pass" if (
